...
const STATIC_FILES = [
  ...
  '/assets/css/mobile-navigation-fix.css',
  '/assets/css/tax-calculator.css',
  '/assets/js/core/main.js',
  '/assets/js/core/chart.js',
  '/assets/js/core/ui-enhancements.js',
  '/assets/js/modules/break_schedule.js',
  '/assets/js/modules/calendar.js',
  '/assets/js/modules/mobile-navigation.js',
  '/assets/js/modules/ios-android-navigation-fix.js',
  '/assets/js/modules/tax-calculator.js',
  '/manifest.json',
